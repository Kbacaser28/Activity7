...
<body>
    <h1 class="head text-center display-4 text-dark  mb-3 mt-3"> <?php  echo "FAMOUS QUOTES"; ?></h1>
    <div class= container>
        ...
        <a class="text-light mr-1 float-right btn btn-secondary text-dark" href = "add.html">Add new Data </a>

        <p><a href="logout.php" class="btn btn-secondary text-dark">Logout</a></p>
    </div>
